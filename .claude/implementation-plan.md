...
|-------|----------|---------|------|----------|
| Phase 1.1 | 데이터베이스 스키마 마이그레이션 | 🔴 최우선 | ✅ 완료 | 0.5일 (Flyway 파일만) |
| Phase 1.2 | 회원가입 및 인증 시스템 완성 | 🔴 최우선 | ✅ 완료 | 2-3일 |
| Phase 2.1 | 공개 상품 API (목록/검색/상세) | 🟡 높음 | ✅ 완료 | 2-3일 |
| Phase 2.2 | SELLER 전용 상품 관리 API | 🟡 높음 | ✅ 완료 | 2-3일 |
